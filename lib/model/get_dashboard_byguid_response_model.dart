...
//
//     final getAllDashBoardByGuidModel = getAllDashBoardByGuidModelFromJson(jsonString);

import 'dart:convert';

import 'product_list_model/get_commercial_services_res_model.dart';

GetAllDashBoardByGuidModel getAllDashBoardByGuidModelFromJson(String str) =>
    GetAllDashBoardByGuidModel.fromJson(json.decode(str));

String getAllDashBoardByGuidModelToJson(GetAllDashBoardByGuidModel data) =>
    json.encode(data.toJson());

class GetAllDashBoardByGuidModel {
  int? id;
  int? categoryId;
  dynamic tableRefGuid;
  dynamic title;
  dynamic discription;
  int? price;
  ...
  factory GetAllDashBoardByGuidModel.fromJson(Map<String, dynamic> json) =>
      GetAllDashBoardByGuidModel(
        id: json["id"],
