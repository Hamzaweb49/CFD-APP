...
class _BookDetailsScreenState extends State<BookDetailsScreen> {
  ...
  GetBookResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<GetBookController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.bookImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData?.bookImageList?[index].imageUrl ??
                                '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData?.bookImageList?.length == 0
                              ? true
                              : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.bookImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
