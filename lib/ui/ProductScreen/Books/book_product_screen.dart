...
import 'package:claxified_app/ui/ProductScreen/Books/book_screen_controller.dart';
...
class BookProductScreen extends StatefulWidget {
  ...
  @override
  State<BookProductScreen> createState() => _BookProductScreenState();
}

class _BookProductScreenState extends State<BookProductScreen> {
  GetBookController getBookController = Get.put(GetBookController());
  ...
  Future getData() async {
    await getBookController.getAllBooksData(Get.arguments?.id);
  }
    ...
    return AppContainer(
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<GetBookController>(
            builder: (controller) {
              return Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: controller.isLoading.value
                          ...
                          : controller.bookFilterData.isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  physics: const BouncingScrollPhysics(),
                                  itemCount: controller.bookFilterData.length,
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      onTap: () {
                                        Get.toNamed(Routes.bookDetailsScreen,
                                            arguments: controller
                                                .bookFilterData[index]);
                                      },
                                      child: Container(
                                        ...
                                        child: Stack(
                                          children: [
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                child: '${controller.bookFilterData[index].title}'.boldMontserratTextStyle(
                                                                    fontSize:
                                                                        14,
                                                                    textOverflow:
                                                                        TextOverflow
                                                        ...
                                                        '₹ ${controller.bookFilterData[index].price}'
                                                            .semiBoldMontserratTextStyle(
                                                                fontSize: 18),
                                                        Row(
                                                          children: [
                                                            ...
                                                            Builder(builder:
                                                              ...
                                                              final stateName =
                                                                  stateAbbreviation(controller
                                                                      ...
                                                                      .toString());
                                                              return Expanded(
                                                                child: "${controller.bookFilterData[index].nearBy} ${'${controller.bookFilterData[index].city}'}($stateName)".semiBoldMontserratTextStyle(
                                                                    maxLine: 3,
                                                                    textOverflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                          ...
                                                          children: [
                                                            AppString
                                                                ...
                                                                .regularMontserratTextStyle(
                                                                    fontSize:
                                                                        10),
                                                            "  :  ${DateFormat('dd/MM/yyyy').format(DateTime.parse('${controller.bookFilterData[index].createdOn}'))}"
                                                                .semiBoldMontserratTextStyle(
                                                                    fontSize:
                                                                        10)
                                                          ],
                                            ...
                                            controller.bookFilterData[index]
                                                        .isPremium ==
                                                    true
                                                ? Positioned(
                                                    left: w * 0.098,
