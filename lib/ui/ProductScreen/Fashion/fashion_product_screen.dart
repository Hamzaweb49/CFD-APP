...
import 'package:claxified_app/ui/ProductScreen/Fashion/fashion_controller.dart';
...
class _FashionProductScreenState extends State<FashionProductScreen> {
  ...
  Future getData() async {
    await fashionController.getFashionData(Get.arguments?.id);
  }
    ...
    return AppContainer(
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<FashionController>(
            builder: (controller) {
              return Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: controller.isLoading.value
                          ...
                          : controller.fashionFilterData.isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  physics: const BouncingScrollPhysics(),
                                  itemCount:
                                      controller.fashionFilterData.length,
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      onTap: () {
                                        Get.toNamed(Routes.fashionDetailsScreen,
                                            arguments: controller
                                                .fashionFilterData[index]);
                                      },
                                      child: Container(
                                        ...
                                        child: Stack(
                                          children: [
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                child: '${controller.fashionFilterData[index].title}'.boldMontserratTextStyle(
                                                                    fontSize:
                                                                        14,
                                                                    textOverflow:
                                                                        TextOverflow
                                                        ...
                                                        '₹ ${controller.fashionFilterData[index].price}'
                                                            .semiBoldMontserratTextStyle(
                                                                fontSize: 18),
                                                        Row(
                                                          children: [
                                                            ...
                                                            Builder(builder:
                                                              ...
                                                              final stateName =
                                                                  stateAbbreviation(controller
                                                                      ...
                                                                      .toString());
                                                              return Expanded(
                                                                child: "${controller.fashionFilterData[index].nearBy} ${'${controller.fashionFilterData[index].city}'}($stateName)".semiBoldMontserratTextStyle(
                                                                    maxLine: 3,
                                                                    textOverflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                          ...
                                                          children: [
                                                            AppString
                                                                ...
                                                                .regularMontserratTextStyle(
                                                                    fontSize:
                                                                        10),
                                                            "  :  ${DateFormat('dd/MM/yyyy').format(DateTime.parse('${controller.fashionFilterData[index].createdOn}'))}"
                                                                .semiBoldMontserratTextStyle(
                                                                    fontSize:
                                                                        10)
                                                          ],
                                            ...
                                            controller.fashionFilterData[index]
                                                        .isPremium ==
                                                    true
                                                ? Positioned(
                                                    left: w * 0.098,
