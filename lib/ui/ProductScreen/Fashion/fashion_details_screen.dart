...
class _FashionDetailsScreenState extends State<FashionDetailsScreen> {
  ...
  GetAllFashionDataResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<FashionController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.fashionImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData
                                    ?.fashionImageList?[index].imageUrl ??
                                '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse:
                              productData?.fashionImageList?.isEmpty ?? false
                                  ? true
                                  : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.fashionImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
