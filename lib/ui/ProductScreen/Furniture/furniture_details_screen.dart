...
class _FurnitureDetailsScreenState extends State<FurnitureDetailsScreen> {
  ...
  GetFurnitureResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<GetFurnitureController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.furnitureImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData
                                    ?.furnitureImageList?[index].imageUrl ??
                                '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData?.furnitureImageList?.length == 0
                              ? true
                              : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.furnitureImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
