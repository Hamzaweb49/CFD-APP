...
import 'package:claxified_app/ui/ProductScreen/Furniture/furniture_screen_controller.dart';
...
class _FurnitureProductScreenState extends State<FurnitureProductScreen> {
  ...
  GetFurnitureController getFurnitureController =
      Get.put(GetFurnitureController());
  ProductScreenController productScreenController =
      Get.put(ProductScreenController());
  SubCategoryResponseModel? selectedData;

  Future getData() async {
    await getFurnitureController.getAllFurnitureData(Get.arguments?.id);
  }
    ...
    return AppContainer(
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<GetFurnitureController>(
            builder: (controller) {
              return Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: controller.isLoading.value
                          ...
                          : controller.filterFurnitureData.isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  physics: const BouncingScrollPhysics(),
                                  itemCount:
                                      controller.filterFurnitureData.length,
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      onTap: () {
                                        Get.toNamed(
                                            Routes.furnitureDetailsScreen,
                                            arguments: controller
                                                .filterFurnitureData[index]);
                                      },
                                      child: Container(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                child: '${controller.filterFurnitureData[index].title}'.boldMontserratTextStyle(
                                                                    fontSize:
                                                                        14,
                                                                    textOverflow:
                                                                        TextOverflow
                                                        ...
                                                        '₹ ${controller.filterFurnitureData[index].price}'
                                                            .semiBoldMontserratTextStyle(
                                                                fontSize: 18),
                                                        Row(
                                                          children: [
                                                            ...
                                                            Builder(builder:
                                                              ...
                                                              final stateName =
                                                                  stateAbbreviation(controller
                                                                      ...
                                                                      .toString());
                                                              return Expanded(
                                                                child: "${controller.filterFurnitureData[index].nearBy} ${'${controller.filterFurnitureData[index].city}'}($stateName)".semiBoldMontserratTextStyle(
                                                                    maxLine: 3,
                                                                    textOverflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                          ...
                                                          children: [
                                                            AppString
                                                                ...
                                                                .regularMontserratTextStyle(
                                                                    fontSize:
                                                                        10),
                                                            "  :  ${DateFormat('dd/MM/yyyy').format(DateTime.parse('${controller.filterFurnitureData[index].createdOn}'))}"
                                                                .semiBoldMontserratTextStyle(
                                                                    fontSize:
                                                                        10)
                                                          ],
