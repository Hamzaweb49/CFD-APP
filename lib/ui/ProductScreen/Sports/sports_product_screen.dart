...
import 'package:claxified_app/ui/ProductScreen/Sports/sports_controller.dart';
...
class SportProductScreen extends StatefulWidget {
  const SportProductScreen({
    super.key,
  });

  @override
  State<SportProductScreen> createState() => _SportProductScreenState();
}

class _SportProductScreenState extends State<SportProductScreen> {
  SportsController fashionController = Get.put(SportsController());
  ...
  Future getData() async {
    await fashionController.getSportsData(Get.arguments?.id);
  }
    ...
    return AppContainer(
      child: SafeArea(
        child: Scaffold(
          ...
          body: GetBuilder<SportsController>(
            builder: (controller) {
              return Padding(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: controller.isLoading.value
                          ...
                          : controller.sportsFilterData.isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  physics: const BouncingScrollPhysics(),
                                  itemCount: controller.sportsFilterData.length,
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      onTap: () {
                                        Get.toNamed(Routes.sportsDetailsScreen,
                                            arguments: controller
                                                .sportsFilterData[index]);
                                      },
                                      child: Container(
                                        ...
                                        child: Stack(
                                          children: [
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                child: '${controller.sportsFilterData[index].title}'.boldMontserratTextStyle(
                                                                    fontSize:
                                                                        14,
                                                                    textOverflow:
                                                                        TextOverflow
                                                        ...
                                                        '₹ ${controller.sportsFilterData[index].price}'
                                                            .semiBoldMontserratTextStyle(
                                                                fontSize: 18),
                                                        Row(
                                                          children: [
                                                            ...
                                                            Builder(builder:
                                                              ...
                                                              final stateName =
                                                                  stateAbbreviation(controller
                                                                      ...
                                                                      .toString());
                                                              return Expanded(
                                                                child: "${controller.sportsFilterData[index].nearBy} ${'${controller.sportsFilterData[index].city}'}($stateName)".semiBoldMontserratTextStyle(
                                                                    maxLine: 3,
                                                                    textOverflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                          ...
                                                          children: [
                                                            AppString
                                                                ...
                                                                .regularMontserratTextStyle(
                                                                    fontSize:
                                                                        10),
                                                            "  :  ${DateFormat('dd/MM/yyyy').format(DateTime.parse('${controller.sportsFilterData[index].createdOn}'))}"
                                                                .semiBoldMontserratTextStyle(
                                                                    fontSize:
                                                                        10)
                                                          ],
                                            ...
                                            controller.sportsFilterData[index]
                                                        .isPremium ==
                                                    true
                                                ? Positioned(
                                                    left: w * 0.098,
