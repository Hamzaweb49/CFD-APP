...
import 'package:claxified_app/ui/ProductScreen/Pet/pet_controller.dart';
...
class PetProductScreen extends StatefulWidget {
  const PetProductScreen({
    super.key,
  });

  @override
  State<PetProductScreen> createState() => _PetProductScreenState();
}

class _PetProductScreenState extends State<PetProductScreen> {
  PetController fashionController = Get.put(PetController());
  ...
  Future getData() async {
    await fashionController.getPetData(Get.arguments?.id);
  }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: controller.isLoading.value
                          ...
                          : controller.petFilterData.isEmpty
                              ? Center(
                              ...
                              : ListView.builder(
                                  physics: const BouncingScrollPhysics(),
                                  itemCount: controller.petFilterData.length,
                                  itemBuilder: (context, index) {
                                      ...
                                      child: Container(
                                        ...
                                        child: Stack(
                                          children: [
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                child: '${controller.petFilterData[index].title}'.boldMontserratTextStyle(
                                                                    fontSize:
                                                                        14,
                                                                    textOverflow:
                                                                        TextOverflow
                                                        ...
                                                        '₹ ${controller.petFilterData[index].price}'
                                                            .semiBoldMontserratTextStyle(
                                                                fontSize: 18),
                                                        Row(
                                                          children: [
                                                            ...
                                                            Builder(builder:
                                                              ...
                                                              final stateName =
                                                                  stateAbbreviation(controller
                                                                      ...
                                                                      .toString());
                                                              return Expanded(
                                                                child: "${controller.petFilterData[index].nearBy} ${'${controller.petFilterData[index].city}'}($stateName)".semiBoldMontserratTextStyle(
                                                                    maxLine: 3,
                                                                    textOverflow:
                                                                        TextOverflow
                                                                            .ellipsis,
                                                          ...
                                                          children: [
                                                            AppString
                                                                ...
                                                                .regularMontserratTextStyle(
                                                                    fontSize:
                                                                        10),
                                                            "  :  ${DateFormat('dd/MM/yyyy').format(DateTime.parse('${controller.petFilterData[index].createdOn}'))}"
                                                                .semiBoldMontserratTextStyle(
                                                                    fontSize:
                                                                        10)
                                                          ],
                                            ...
                                            controller.petFilterData[index]
                                                        .isPremium ==
                                                    true
                                                ? Positioned(
                                                    left: w * 0.098,
