...
class _VehicleDetailsScreenState extends State<VehicleDetailsScreen> {
  ...
  GetAllVehicleResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<GetVehicleController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.vehicleImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData
                                    ?.vehicleImageList?[index].imageUrl ??
                                '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData?.vehicleImageList?.length == 0
                              ? true
                              : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.vehicleImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        (productData?.transmissionType == 0
                                                ? "Manual"
                                                : "Automatic")
                                            .w500MontserratTextStyle(),
                                      ],
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          "Fuel type".w500MontserratTextStyle(),
                                          const Spacer(),
                                          (productData?.fuelType == 0
                                                  ? "Petrol"
                                                  : productData?.fuelType == 1
                                                      ? "Diesel"
