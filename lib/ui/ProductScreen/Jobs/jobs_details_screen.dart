...
import 'package:claxified_app/ui/ProductScreen/Jobs/jobs_screen_controller.dart';
...
class _JobsDetailsScreenState extends State<JobsDetailsScreen> {
  ...
  GetJobsResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<GetJobsController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.jobImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData!.jobImageList == null
                                ? ""
                                : productData!.jobImageList![index].imageUrl
                                    .toString(),
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData?.jobImageList?.length == 0
                              ? true
                              : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.jobImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          (h * 0.002).addHSpace(),
                          '₹ ${productData?.salaryFrom}-${productData?.salaryTo} | ${productData?.salaryPeriodType == 0 ? 'Hourly' : productData?.salaryPeriodType == 1 ? 'Monthly' : productData?.salaryPeriodType == 2 ? 'Weekly' : 'Yearly'}'
