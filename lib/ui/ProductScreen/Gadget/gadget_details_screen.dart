...
class GadgetDetailsScreen extends StatefulWidget {
  const GadgetDetailsScreen({super.key});

  @override
  State<GadgetDetailsScreen> createState() => _GadgetDetailsScreenState();
}

class _GadgetDetailsScreenState extends State<GadgetDetailsScreen> {
  ...
  GetAllGadgetResponseModel? productData;
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<GetGadgetController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount: productData?.gadgetImageList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url:
                                productData?.gadgetImageList?[index].imageUrl ??
                                    '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData?.gadgetImageList?.length == 0
                              ? true
                              : false,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          productData?.gadgetImageList?.length ?? 1,
                          (index) => Container(
                            height: h * 0.006,
                            width: h * 0.017,
