...
class CommercialServicesDetailsScreen extends StatefulWidget {
  const CommercialServicesDetailsScreen({super.key});

  @override
  State<CommercialServicesDetailsScreen> createState() =>
      _CommercialServicesDetailsScreenState();
}

class _CommercialServicesDetailsScreenState
    extends State<CommercialServicesDetailsScreen> {
  ...
  GetAllCommercialServicesResponseModel? productData;
  ...
  Widget build(BuildContext context) {
    String formattedTime = DateFormat.yMd()
        .format(DateTime.parse(productData?.createdOn.toString() ?? ''));
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: GetBuilder<CommercialServicesController>(
              builder: (controller) {
                return Column(
                  ...
                  children: [
                    ...
                    CarouselSlider.builder(
                      itemCount:
                          productData?.commercialServiceImagesList?.length ?? 1,
                      itemBuilder:
                          (BuildContext context, int index, int realIndex) {
                        return cachedNetworkImage(
                            url: productData
                                    ?.commercialServiceImagesList?[index]
                                    .imageUrl ??
                                '',
                            height: h * 0.1);
                      },
                      options: CarouselOptions(
                          ...
                          autoPlay: false,
                          reverse: productData
                                      ?.commercialServiceImagesList?.isEmpty ??
                                  false
                              ? true
                              : false,
