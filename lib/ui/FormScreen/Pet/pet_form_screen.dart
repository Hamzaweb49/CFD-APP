...
import 'package:claxified_app/ui/FormScreen/Pet/pet_form_controller.dart';
...
class _PetFormScreenState extends State<PetFormScreen> {
  PetFormController petFormController = Get.put(PetFormController());
  ...
  Future getData() async {
    if (Get.arguments['isFrom'] == 'EditScreen') {
      petFormController.getAllPetData = Get.arguments['ModelData'];
    }
    await petFormController.getStateData();
    if (preferences
      ...
      petFormController.nameController.text =
          userLoginOtpResponseModel?.firstName ?? '';
      petFormController.phoneController.text =
  ...
  void initState() {
    getData();
    petFormController.clearData();
    if (Get.arguments['isFrom'] == 'EditScreen') {
      petFormController.assignData();
    }
    super.initState();
  }
  ...
  @override
  void dispose() {
    petFormController.getAllNearByResponseModel = [];
    petFormController.getAllCityResponseModel = [];
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      child: GetBuilder<PetFormController>(
        builder: (controller) {
          return SafeArea(
            child: Scaffold(
                                    ...
                                    if (controller
                                      ...
                                      Map<String, dynamic> petData = {
                                        ...
                                        "isPremium": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllPetData[0].isPremium
                                            : false,
                                        "isActive": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllPetData[0].isActive
                                            : false,
                                        "isVerified": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllPetData[0].isVerified
                                            : false,
                                        ...
                                        "tableRefGuid":
                                            Get.arguments['isFrom'] ==
                                                    'EditScreen'
                                                ? controller.getAllPetData[0]
                                                    .tableRefGuid
                                                : "",
                                        "id": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller.getAllPetData[0].id
                                            : 0,
                                        "subCategoryId": selectedData.id,
                                        "petImageList": petDataImageList,
                                      };

                                      if (Get.arguments['isFrom'] ==
                                          'FormScreen') {
                                        await controller.addPetData(
                                            pet: petData);
                                      } else {
                                        controller.updatePetsData(
                                          id: controller.getAllPetData[0].id
                                              .toString(),
                                          petsData: petData,
                                        );
                                      }
