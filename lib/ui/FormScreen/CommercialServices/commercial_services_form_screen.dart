...
import 'package:claxified_app/ui/FormScreen/CommercialServices/commercial_services_form_controller.dart';
...
class CommercialServicesFormScreen extends StatefulWidget {
  const CommercialServicesFormScreen({super.key});

  @override
  State<CommercialServicesFormScreen> createState() =>
      _CommercialServicesFormScreenState();
}

class _CommercialServicesFormScreenState
    extends State<CommercialServicesFormScreen> {
  CommercialServicesFormController commercialServicesFormController =
      Get.put(CommercialServicesFormController());
  ...
  Future getData() async {
    if (Get.arguments['isFrom'] == 'EditScreen') {
      commercialServicesFormController.getAllCommercialData =
          Get.arguments['ModelData'];
    }
    await commercialServicesFormController.getStateData();
    if (preferences
      ...
      commercialServicesFormController.nameController.text =
          userLoginOtpResponseModel?.firstName ?? '';
      commercialServicesFormController.phoneController.text =
  ...
  @override
  void initState() {
    commercialServicesFormController.clearData();
    getData();
    if (Get.arguments['isFrom'] == 'EditScreen') {
      commercialServicesFormController.assignData();
    }
    super.initState();
  }
  ...
  @override
  void dispose() {
    commercialServicesFormController.getAllNearByResponseModel = [];
    commercialServicesFormController.getAllCityResponseModel = [];
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      child: GetBuilder<CommercialServicesFormController>(
        builder: (controller) {
          return SafeArea(
            child: Scaffold(
                                    ...
                                    if (controller
                                      ...
                                      if (controller.imageUrl.isNotEmpty) {
                                        for (var element
                                          ...
                                          commercialServicesImageList.addAll({
                                            {
                                              "id": 0,
                                              "imageId": "",
                                              "imageURL": element,
                                      ...
                                      Map<String, dynamic>
                                        ...
                                        "isPremium": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller.getAllCommercialData[0]
                                                .isPremium
                                            : false,
                                        ...
                                        "tableRefGuid":
                                            Get.arguments['isFrom'] ==
                                                    'EditScreen'
                                                ? controller
                                                    .getAllCommercialData[0]
                                                    .tableRefGuid
                                                : "",
                                        "id": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllCommercialData[0].id
                                            : 0,
