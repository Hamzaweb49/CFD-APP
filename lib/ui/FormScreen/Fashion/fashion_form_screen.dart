...
import 'package:claxified_app/ui/FormScreen/Fashion/fashion_form_controller.dart';
...
class FashionFormScreen extends StatefulWidget {
  const FashionFormScreen({super.key});

  @override
  State<FashionFormScreen> createState() => _FashionFormScreenState();
}

class _FashionFormScreenState extends State<FashionFormScreen> {
  FashionFormController fashionFormController =
      Get.put(FashionFormController());
  ...
  Future getData() async {
    if (Get.arguments['isFrom'] == 'EditScreen') {
      fashionFormController.getAllFashionData = Get.arguments['ModelData'];
    }
    await fashionFormController.getStateData();
    if (preferences
      ...
      fashionFormController.nameController.text =
          userLoginOtpResponseModel?.firstName ?? '';
      fashionFormController.phoneController.text =
  ...
  void initState() {
    getData();
    fashionFormController.clearData();
    if (Get.arguments['isFrom'] == 'EditScreen') {
      fashionFormController.assignData();
    }
    super.initState();
  }
  ...
  @override
  void dispose() {
    fashionFormController.getAllNearByResponseModel = [];
    fashionFormController.getAllCityResponseModel = [];
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      child: GetBuilder<FashionFormController>(
        builder: (controller) {
          return SafeArea(
            child: Scaffold(
                                    ...
                                    if (controller
                                      ...
                                      Map<String, dynamic> fashion = {
                                        ...
                                        "isPremium": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllFashionData[0].isPremium
                                            : false,
                                        "isActive": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllFashionData[0].isActive
                                            : false,
                                        "isVerified": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllFashionData[0].isVerified
                                            : false,
                                        ...
                                        "id": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller.getAllFashionData[0].id
                                            : 0,
                                      ...
                                      if (Get.arguments['isFrom'] ==
                                          'FormScreen') {
                                        await controller.addFashionData(
                                            fashion: fashion);
                                      } else {
                                        controller.updateFashionAllData(
                                          id: controller.getAllFashionData[0].id
                                              .toString(),
                                          updateFashionData: fashion,
                                        );
                                      }
                                    }
                                  },
