...
import 'package:claxified_app/ui/FormScreen/Furniture/furniture_form_controller.dart';
...
class FurnitureFormScreen extends StatefulWidget {
  const FurnitureFormScreen({super.key});

  @override
  State<FurnitureFormScreen> createState() => _FurnitureFormScreenState();
}

class _FurnitureFormScreenState extends State<FurnitureFormScreen> {
  FurnitureFormController furnitureFormController =
  ...
  Future getData() async {
    if (Get.arguments['isFrom'] == 'EditScreen') {
      furnitureFormController.getAllFurnitureData = Get.arguments['ModelData'];
    }
    await furnitureFormController.getStateData();
    if (preferences
      ...
      furnitureFormController.nameController.text =
          userLoginOtpResponseModel?.firstName ?? '';
      furnitureFormController.phoneController.text =
  ...
  void initState() {
    getData();
    furnitureFormController.clearData();
    if (Get.arguments['isFrom'] == 'EditScreen') {
      furnitureFormController.assignData();
    }
  ...
  @override
  void dispose() {
    furnitureFormController.getAllNearByResponseModel = [];
    furnitureFormController.getAllCityResponseModel = [];
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      child: GetBuilder<FurnitureFormController>(
        builder: (controller) {
          return SafeArea(
            child: Scaffold(
                                    ...
                                    if (controller
                                      ...
                                      Map<String, dynamic> furnitureData = {
                                        ...
                                        "isPremium": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller.getAllFurnitureData[0]
                                                .isPremium
                                            : false,
                                        "isActive": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllFurnitureData[0].isActive
                                            : false,
                                        ...
                                        "tableRefGuid":
                                            Get.arguments['isFrom'] ==
                                                    'EditScreen'
                                                ? controller
                                                    .getAllFurnitureData[0]
                                                    .tableRefGuid
                                                : "",
                                        "id": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllFurnitureData[0].id
                                            : 0,
                                        "furnitureImageList":
                                            furnitureImageList,
                                      ...
                                      if (Get.arguments['isFrom'] ==
                                          'FormScreen') {
                                        await controller.addFurnitureData(
                                            furnitureData: furnitureData);
                                      } else {
                                        controller.updateFurnitureAllData(
                                          id: controller
                                              .getAllFurnitureData[0].id
                                              .toString(),
                                          furnitureData: furnitureData,
