...
import 'package:claxified_app/ui/FormScreen/Book/book_form_controller.dart';
...
class _BookFormScreenState extends State<BookFormScreen> {
  BookFormController bookFormController = Get.put(BookFormController());
  ...
  Future getData() async {
    if (Get.arguments['isFrom'] == 'EditScreen') {
      ...
      bookFormController.getAllBooksData = Get.arguments['ModelData'];
    }
    await bookFormController.getStateData();
    if (preferences
      ...
      bookFormController.nameController.text =
          userLoginOtpResponseModel?.firstName ?? '';
      bookFormController.phoneController.text =
  ...
  void initState() {
    getData();
    bookFormController.clearData();
    if (Get.arguments['isFrom'] == 'EditScreen') {
      bookFormController.assignData();
    }
    super.initState();
  }
  ...
  @override
  void dispose() {
    bookFormController.getAllNearByResponseModel = [];
    bookFormController.getAllCityResponseModel = [];
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      child: GetBuilder<BookFormController>(
        builder: (controller) {
          return SafeArea(
            child: Scaffold(
                              ...
                              : AppFilledButton(
                                  onPressed: () async {
                                    ...
                                    if (controller
                                      ...
                                      List<Map<String, dynamic>> bookImageList =
                                          [];
                                      ...
                                      Map<String, dynamic> bookData = {
                                        ...
                                        "isPremium": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllBooksData[0].isPremium
                                            : false,
                                        "isActive": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllBooksData[0].isActive
                                            : false,
                                        "isVerified": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller
                                                .getAllBooksData[0].isVerified
                                            : false,
                                        ...
                                        "tableRefGuid":
                                            Get.arguments['isFrom'] ==
                                                    'EditScreen'
                                                ? controller.getAllBooksData[0]
                                                    .tableRefGuid
                                                : "",
                                        "id": Get.arguments['isFrom'] ==
                                                'EditScreen'
                                            ? controller.getAllBooksData[0].id
                                            : 0,
                                      ...
                                      if (Get.arguments['isFrom'] ==
                                          'FormScreen') {
                                        await controller.addBookData(
                                            bookData: bookData);
                                      } else {
                                        controller.updateBookData(
                                          id: controller.getAllBooksData[0].id
                                              .toString(),
